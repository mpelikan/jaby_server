( function () {
	...
	exports.getTumblr = function ( req, res, next ) {
		...
		client.posts( "withinthisnightmare.tumblr.com", {
			type: "photo"
		}, function ( err, data ) {
			if ( err ) {
				return next( err );
	...
	exports.getGithub = function ( req, res, next ) {
		...
		var repo = github.getRepo( "mpelikan", "jaby_server" );
	...
	exports.getNewYorkTimes = function ( req, res, next ) {
		...
		request.get( url, function ( err, request, body ) {
			...
			if ( request.statusCode === 403 ) {
				return next( new Error( "Missing or Invalid New York Times API Key" ) );
			}
