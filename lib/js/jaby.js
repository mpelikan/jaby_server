...
( function ( window, document, exportName ) {
	...
	jaby.doRight = function doRight() {
		var thisSlide = communiqué.getCurrentSlide();
		var id = thisSlide.getAttribute( "id" );
		var indices = communiqué.getIndices();
		var indexToRemove;
	...
	jaby.doLeft = function doLeft() {
		var previousSlide = communiqué.getPreviousSlide();
		if ( previousSlide ) {
	...
	jaby.setupCommuniqué = function setupCommuniqué() {
		...
		communiqué.addEventListener( "slidechanged", function ( event ) {
